 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/Conference/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://server/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Conference/user?wsdl");
    ...
    public User getUserPort() {
        return super.getPort(new QName("http://server/", "UserPort"), User.class);
    }
    ...
    public User getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "UserPort"), User.class, features);
    }
