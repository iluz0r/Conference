 ...
 * 
 */
@WebService(name = "Participant", targetNamespace = "http://server/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface Participant {
    ...
    @Action(input = "http://server/Participant/equalsRequest", output = "http://server/Participant/equalsResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getIdPaper", targetNamespace = "http://server/", className = "stub.GetIdPaper")
    @ResponseWrapper(localName = "getIdPaperResponse", targetNamespace = "http://server/", className = "stub.GetIdPaperResponse")
    @Action(input = "http://server/Participant/getIdPaperRequest", output = "http://server/Participant/getIdPaperResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getTitlePaper", targetNamespace = "http://server/", className = "stub.GetTitlePaper")
    @ResponseWrapper(localName = "getTitlePaperResponse", targetNamespace = "http://server/", className = "stub.GetTitlePaperResponse")
    @Action(input = "http://server/Participant/getTitlePaperRequest", output = "http://server/Participant/getTitlePaperResponse")
    ...
    @Action(input = "http://server/Participant/getNameRequest", output = "http://server/Participant/getNameResponse")
    ...
    @Action(input = "http://server/Participant/setNameRequest", output = "http://server/Participant/setNameResponse")
    public void setName(
        @WebParam(name = "arg0", targetNamespace = "")
        String arg0);
    ...
    @Action(input = "http://server/Participant/isAdminRequest", output = "http://server/Participant/isAdminResponse")
    ...
    @Action(input = "http://server/Participant/setAdminRequest", output = "http://server/Participant/setAdminResponse")
    ...
    @Action(input = "http://server/Participant/setSurnameRequest", output = "http://server/Participant/setSurnameResponse")
