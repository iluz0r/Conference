 ...
 * 
 */
@WebServiceClient(name = "AdminService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/Conference/admin?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADMINSERVICE_QNAME = new QName("http://server/", "AdminService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Conference/admin?wsdl");
    ...
    public Admin getAdminPort() {
        return super.getPort(new QName("http://server/", "AdminPort"), Admin.class);
    }
    ...
    public Admin getAdminPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "AdminPort"), Admin.class, features);
    }
